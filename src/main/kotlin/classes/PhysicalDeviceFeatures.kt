...
class PhysicalDeviceFeatures(
    ...
    val MemoryStack.native: Ptr
        get() = ncalloc(ALIGNOF, 1, SIZEOF).also {
            nrobustBufferAccess(it, robustBufferAccess.i)
            nfullDrawIndexUint32(it, fullDrawIndexUint32.i)
            nimageCubeArray(it, imageCubeArray.i)
            nindependentBlend(it, independentBlend.i)
            ngeometryShader(it, geometryShader.i)
            ntessellationShader(it, tessellationShader.i)
            nsampleRateShading(it, sampleRateShading.i)
            ndualSrcBlend(it, dualSrcBlend.i)
            nlogicOp(it, logicOp.i)
            nmultiDrawIndirect(it, multiDrawIndirect.i)
            ndrawIndirectFirstInstance(it, drawIndirectFirstInstance.i)
            ndepthClamp(it, depthClamp.i)
            ndepthBiasClamp(it, depthBiasClamp.i)
            nfillModeNonSolid(it, fillModeNonSolid.i)
            ndepthBounds(it, depthBounds.i)
            nwideLines(it, wideLines.i)
            nlargePoints(it, largePoints.i)
            nalphaToOne(it, alphaToOne.i)
            nmultiViewport(it, multiViewport.i)
            nsamplerAnisotropy(it, samplerAnisotropy.i)
            ntextureCompressionETC2(it, textureCompressionETC2.i)
            ntextureCompressionASTC_LDR(it, textureCompressionASTC_LDR.i)
            ntextureCompressionBC(it, textureCompressionBC.i)
            nocclusionQueryPrecise(it, occlusionQueryPrecise.i)
            npipelineStatisticsQuery(it, pipelineStatisticsQuery.i)
            nvertexPipelineStoresAndAtomics(it, vertexPipelineStoresAndAtomics.i)
            nfragmentStoresAndAtomics(it, fragmentStoresAndAtomics.i)
            nshaderTessellationAndGeometryPointSize(it, shaderTessellationAndGeometryPointSize.i)
            nshaderImageGatherExtended(it, shaderImageGatherExtended.i)
            nshaderStorageImageExtendedFormats(it, shaderStorageImageExtendedFormats.i)
            nshaderStorageImageMultisample(it, shaderStorageImageMultisample.i)
            nshaderStorageImageReadWithoutFormat(it, shaderStorageImageReadWithoutFormat.i)
            nshaderStorageImageWriteWithoutFormat(it, shaderStorageImageWriteWithoutFormat.i)
            nshaderUniformBufferArrayDynamicIndexing(it, shaderUniformBufferArrayDynamicIndexing.i)
            nshaderSampledImageArrayDynamicIndexing(it, shaderSampledImageArrayDynamicIndexing.i)
            nshaderStorageBufferArrayDynamicIndexing(it, shaderStorageBufferArrayDynamicIndexing.i)
            nshaderStorageImageArrayDynamicIndexing(it, shaderStorageImageArrayDynamicIndexing.i)
            nshaderClipDistance(it, shaderClipDistance.i)
            nshaderCullDistance(it, shaderCullDistance.i)
            nshaderFloat64(it, shaderFloat64.i)
            nshaderInt64(it, shaderInt64.i)
            nshaderInt16(it, shaderInt16.i)
            nshaderResourceResidency(it, shaderResourceResidency.i)
            nshaderResourceMinLod(it, shaderResourceMinLod.i)
            nsparseBinding(it, sparseBinding.i)
            nsparseResidencyBuffer(it, sparseResidencyBuffer.i)
            nsparseResidencyImage2D(it, sparseResidencyImage2D.i)
            nsparseResidencyImage3D(it, sparseResidencyImage3D.i)
            nsparseResidency2Samples(it, sparseResidency2Samples.i)
            nsparseResidency4Samples(it, sparseResidency4Samples.i)
            nsparseResidency8Samples(it, sparseResidency8Samples.i)
            nsparseResidency16Samples(it, sparseResidency16Samples.i)
            nsparseResidencyAliased(it, sparseResidencyAliased.i)
            nvariableMultisampleRate(it, variableMultisampleRate.i)
            ninheritedQueries(it, inheritedQueries.i)
        }
}